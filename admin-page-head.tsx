  ...
  return (
    <main className="min-h-screen bg-[var(--background)] text-[var(--foreground)] px-4 py-10 font-sans relative">
      ...
      <div className="max-w-3xl mx-auto relative z-10">
        ...
        {/* ิ๖วิ๖ว Staff Management Tab ิ๖วิ๖ว */}
        {activeTab === "staff" && (
          <>
            <div className="mb-10">
        ...
        {/* ิ๖วิ๖ว Invites Tab ิ๖วิ๖ว */}
        {activeTab === "invites" && (
          <>

        {/* ิ๖วิ๖ว Create Mod Invite ิ๖วิ๖ว */}
        <div className="mb-10">
          <h2 className="text-lg font-black mb-3 flex items-center gap-2">
        ...
        {/* ิ๖วิ๖ว Pending Mod Requests ิ๖วิ๖ว */}
        {pendingMod.length > 0 && (
          <div className="mb-10">
            <h2 className="text-lg font-black mb-3 flex items-center gap-2">
        ...
        {/* ิ๖วิ๖ว Reviewed Mod Requests ิ๖วิ๖ว */}
